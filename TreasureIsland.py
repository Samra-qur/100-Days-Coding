...
if user_input=='left':
    user_input=input("You have reached a moutain full of wild animals. Do you want to move or stay").lower()
    if user_input=='move':
        user_input=input("You have came across a hut. There are three color gates: red, yellow, green. Choose one").lower()
        if (user_input == 'red'):
